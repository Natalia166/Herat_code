...
//颜色数组
COLORREF colors[7] = { RGB(206,185,193),RGB(138,85,105) ,RGB(246,153,136) ,RGB(246,88,80) ,RGB(242,153,136) ,RGB(244,195,217) ,RGB(237,142,182) };
...
const int xScreen = 1800;				  //屏幕宽度
const int yScreen = 900;				  //屏幕高度
